...
class Student : public PersonAtMCC {
    ...
    public :
        ...
        Student(long long id, string name, string address, string phone,
            ...
            applied_to_4_year(applied_to_4_year),
        ...
        Student(const Student &copy) : 
            PersonAtMCC(copy),
            major(copy.major),
            credits_received(copy.credits_received),
            applied_to_4_year(copy.applied_to_4_year),
            is_veteran(copy.is_veteran) { }
